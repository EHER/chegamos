	...
	<?php foreach ($visitors as $visitor) { ?>
		<li tabindex="0" class="ui-li-has-thumb ui-li ui-btn ui-btn-up-c" data-theme="c">
			<div class="ui-btn-text">
				<img width="64" height="64" src="<?php echo ($visitor->visitor->user->photo ? $visitor->visitor->user->photo_medium : 'http://www.apontador.com.br/apontador_v8/images/accounts/user64.gif'); ?>" class="ui-li-thumb">
				<h3 class="ui-li-heading"><a href="<?php echo ROOT_URL . 'profile/show/' . $visitor->visitor->user->id; ?>" class="ui-link-inherit"><?php echo $visitor->visitor->user->name; ?></a></h3>
